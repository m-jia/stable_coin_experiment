...
/**
 * @title CADXImplementation
 * @dev This contract is a Pausable ERC20 token with issuance
 * controlled by a central Issuer. By implementing CADXImplementation
 ...
 */
contract CADXImplementation is IERC20 {
    ...
    string internal constant _name = "CADX"; // solium-disable-line
    string internal constant _symbol = "CADX"; // solium-disable-line uppercase
    uint8 internal constant _decimals = 6; // solium-disable-line uppercase
    ...
    function _approve(address owner, address spender, uint256 value) internal {
        ...
        require(spender != address(0), "cannot approve allowance for zero address");
    ...
    */
    ...
    function setComplianceRole(address newComplianceRole) public {
        require(msg.sender == _complianceRole || msg.sender == _owner, "only complianceRole or Owner");
     ...
     * @return A boolean that indicates if the operation was successful.
     */
    function mintTo(address to, uint256 value) public onlyIssuer returns (bool success) {
        _mint(to, value);
     ...
     */
    function _mint(address to, uint256 value) internal onlyIssuer whenNotPaused {
